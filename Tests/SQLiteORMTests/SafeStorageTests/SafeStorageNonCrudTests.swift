...
class SafeStorageNonCrudTests: XCTestCase {
    ...
    func testSelect() throws {
        ...
        try testCase(#function, routine: {
            ...
            remove(filename)
            let storageResult = SafeStorage.create(filename: filename,
            ...
            case .success(let storage):
                switch storage.syncSchema(preserve: false) {
                case .success(_):
                    break
                case .failure(let error):
                    throw error
                }
                switch storage.replace(Employee(id: 1,
                                                firstname: "Andrew",
                                                lastname: "Adams",
                ...
                switch storage.replace(Employee(id: 2,
                                                firstname: "Nancy",
                                                lastname: "Edwards",
                                                title: "Sales Manager",
                ...
                switch storage.replace(Employee(id: 3,
                                                firstname: "Jane",
                                                lastname: "Peacock",
                ...
                switch storage.replace(Employee(id: 4,
                                                firstname: "Margaret",
                                                lastname: "Park",
                                                title: "Sales Support Agent",
                ...
                switch storage.replace(Employee(id: 5,
                                                firstname: "Steve",
                                                lastname: "Johnson",
                                                title: "Sales Support Agent",
                ...
                switch storage.replace(Employee(id: 6,
                                                firstname: "Michael",
                                                lastname: "Mitchell",
                                                title: "IT Manager",
                ...
                switch storage.replace(Employee(id: 7,
                                                firstname: "Robert",
                                                lastname: "King",
                                                title: "IT Staff",
                ...
                switch storage.replace(Employee(id: 8,
                                                firstname: "Laura",
                                                lastname: "Callahan",
                                                title: "IT Staff",
                ...
                try section("one column", routine: {
                    let selectResult: Result<[Int], Error> = storage.select(\Employee.id, from(Employee.self))
                    switch selectResult {
                ...
                try section("two columns", routine: {
                    let selectResult: Result<[(Int, String)], Error> = storage.select(\Employee.id,
                                                                                       \Employee.firstname,
                                                                                       from(Employee.self))
                    switch selectResult {
                ...
                try section("three columns", routine: {
                    let selectResult: Result<[(Int, String, String)], Error> = storage.select(\Employee.id,
                                                                                               \Employee.firstname,
                                                                                               \Employee.lastname,
                                                                                               from(Employee.self))
                    switch selectResult {
